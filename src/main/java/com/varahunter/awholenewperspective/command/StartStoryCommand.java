...
package com.varahunter.awholenewperspective.command;
...
public class StartStoryCommand extends AWholeNewPerspectiveModElements.ModElement {
	public StartStoryCommand(AWholeNewPerspectiveModElements instance) {
		super(instance, 86);
	}
