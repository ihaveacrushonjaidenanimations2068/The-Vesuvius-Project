...
public class ForwardPortalParticle extends AWholeNewPerspectiveModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ForwardPortalParticle(AWholeNewPerspectiveModElements instance) {
		super(instance, 50);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("forward_portal"));
	}
