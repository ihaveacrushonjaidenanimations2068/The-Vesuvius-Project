...
package com.varahunter.awholenewperspective.particle;
...
public class BackwardPortalParticle extends AWholeNewPerspectiveModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public BackwardPortalParticle(AWholeNewPerspectiveModElements instance) {
		super(instance, 51);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("backward_portal"));
	}
