...
public class SubvoliteClusterBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:subvolite_cluster")
	public static final Block block = null;
	public SubvoliteClusterBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("subvolite_cluster");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("subvolite_cluster", "subvolite_cluster", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == VividoniaStoneBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
