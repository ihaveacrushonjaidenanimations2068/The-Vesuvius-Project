...
public class DirectionTestRotatableBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:direction_test_rotatable")
	public static final Block block = null;
	public DirectionTestRotatableBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("direction_test_rotatable");
		}
