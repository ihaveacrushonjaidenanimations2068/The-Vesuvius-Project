...
import com.varahunter.awholenewperspective.procedures.PlasmaPistolTileEntityCollidesInTheBlockProcedure;
...
public class PlasmaPistolTileBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:plasma_pistol_tile")
	public static final Block block = null;
	public PlasmaPistolTileBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("plasma_pistol_tile");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PlasmaPistolItem.block, (int) (1)));
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				PlasmaPistolTileEntityCollidesInTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
