...
public class FlippedOneiricSoilBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:flipped_oneiric_soil")
	public static final Block block = null;
	public FlippedOneiricSoilBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("flipped_oneiric_soil");
		}
