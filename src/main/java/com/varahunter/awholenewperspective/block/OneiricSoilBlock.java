...
public class OneiricSoilBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:oneiric_soil")
	public static final Block block = null;
	public OneiricSoilBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 22);
	}
