...
public class TCFlooringWallBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:tc_flooring_wall")
	public static final Block block = null;
	public TCFlooringWallBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tc_flooring_wall");
		}
