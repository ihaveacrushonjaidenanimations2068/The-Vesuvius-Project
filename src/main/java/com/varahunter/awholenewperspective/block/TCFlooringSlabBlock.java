...
public class TCFlooringSlabBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:tc_flooring_slab")
	public static final Block block = null;
	public TCFlooringSlabBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tc_flooring_slab");
		}
