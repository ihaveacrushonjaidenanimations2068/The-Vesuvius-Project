...
public class DazewoodLogBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:dazewood_log")
	public static final Block block = null;
	public DazewoodLogBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 1);
	}
