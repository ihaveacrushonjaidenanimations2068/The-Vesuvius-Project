...
public class TrainingCourseTerminalBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:training_course_terminal")
	public static final Block block = null;
	public TrainingCourseTerminalBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("training_course_terminal");
		}
