...
public class PetrifiedDazewoodLogBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:petrified_dazewood_log")
	public static final Block block = null;
	public PetrifiedDazewoodLogBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("petrified_dazewood_log");
		}
