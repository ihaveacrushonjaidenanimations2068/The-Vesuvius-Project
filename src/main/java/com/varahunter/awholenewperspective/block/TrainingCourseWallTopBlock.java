...
public class TrainingCourseWallTopBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:training_course_wall_top")
	public static final Block block = null;
	public TrainingCourseWallTopBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("training_course_wall_top");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Top"));
		}
