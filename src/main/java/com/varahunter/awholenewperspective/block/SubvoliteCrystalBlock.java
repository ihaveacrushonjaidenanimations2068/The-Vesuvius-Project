...
public class SubvoliteCrystalBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:subvolite_crystal")
	public static final Block block = null;
	public SubvoliteCrystalBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("subvolite_crystal");
		}
