...
public class OneiricGrassBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:oneiric_grass")
	public static final Block block = null;
	public OneiricGrassBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 4);
	}
