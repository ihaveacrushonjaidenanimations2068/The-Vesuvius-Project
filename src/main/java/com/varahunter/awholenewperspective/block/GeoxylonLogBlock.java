...
public class GeoxylonLogBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:geoxylon_log")
	public static final Block block = null;
	public GeoxylonLogBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 70);
	}
