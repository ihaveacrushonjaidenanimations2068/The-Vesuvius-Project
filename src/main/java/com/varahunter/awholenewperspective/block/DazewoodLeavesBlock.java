...
public class DazewoodLeavesBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:dazewood_leaves")
	public static final Block block = null;
	public DazewoodLeavesBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dazewood_leaves");
		}
