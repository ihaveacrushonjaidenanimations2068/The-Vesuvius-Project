...
public class TrainingCourseWallBottomBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:training_course_wall_bottom")
	public static final Block block = null;
	public TrainingCourseWallBottomBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("training_course_wall_bottom");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Bottom"));
		}
