...
public class ShalamiteBlockBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:shalamite_block")
	public static final Block block = null;
	public ShalamiteBlockBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 47);
	}
