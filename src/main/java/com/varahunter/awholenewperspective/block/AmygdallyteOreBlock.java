...
public class AmygdallyteOreBlock extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:amygdallyte_ore")
	public static final Block block = null;
	public AmygdallyteOreBlock(AWholeNewPerspectiveModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amygdallyte_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UnrefinedAmygdallyteItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("amygdallyte_ore", "amygdallyte_ore", blockAt -> {
