...
import com.varahunter.awholenewperspective.procedures.EnforcerTripminePlayerCollidesWithThisEntityProcedure;
...
public class EnforcerTripmineEntity extends AWholeNewPerspectiveModElements.ModElement {
	public static EntityType entity = null;
	public EnforcerTripmineEntity(AWholeNewPerspectiveModElements instance) {
		super(instance, 67);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 0.4f)).build("enforcer_tripmine")
						.setRegistryName("enforcer_tripmine");
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelEnforcerTeripmine(), 0.5f) {
				{
					this.addLayer(new GlowingLayer<>(this));
				}
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("a_whole_new_perspective:textures/enforcer_tripmine.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				EnforcerTripminePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("a_whole_new_perspective:textures/enforcer_tripmine.png")));
