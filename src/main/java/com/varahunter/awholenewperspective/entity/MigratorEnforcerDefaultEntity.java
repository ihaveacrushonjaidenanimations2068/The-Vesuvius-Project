...
public class MigratorEnforcerDefaultEntity extends AWholeNewPerspectiveModElements.ModElement {
	public static EntityType entity = null;
	public MigratorEnforcerDefaultEntity(AWholeNewPerspectiveModElements instance) {
		super(instance, 66);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f))
						.build("migrator_enforcer_default").setRegistryName("migrator_enforcer_default");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13369345, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("migrator_enforcer_default_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelEnforcer(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("a_whole_new_perspective:textures/camouflagedmigratorenforcerdefault.png");
				}
			};
		});
	}
