...
public class SubvoliteGeodeFeatureStructure extends AWholeNewPerspectiveModElements.ModElement {
	public SubvoliteGeodeFeatureStructure(AWholeNewPerspectiveModElements instance) {
		super(instance, 36);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("a_whole_new_perspective", "subvolite_geode"));
						if (template == null)
							return false;
