...
public class OneirodendronTreeFeatureStructure extends AWholeNewPerspectiveModElements.ModElement {
	public OneirodendronTreeFeatureStructure(AWholeNewPerspectiveModElements instance) {
		super(instance, 25);
	}
