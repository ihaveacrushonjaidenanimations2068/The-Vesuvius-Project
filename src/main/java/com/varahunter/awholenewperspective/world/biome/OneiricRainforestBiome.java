...
import com.varahunter.awholenewperspective.block.OneiricSoilBlock;
...
public class OneiricRainforestBiome extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:oneiric_rainforest")
	public static final CustomBiome biome = null;
	public OneiricRainforestBiome(AWholeNewPerspectiveModElements instance) {
		super(instance, 23);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.1f).scale(0.2f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					...
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(OneiricGrassBlock.block.getDefaultState(),
							OneiricSoilBlock.block.getDefaultState(), OneiricSoilBlock.block.getDefaultState())));
			setRegistryName("oneiric_rainforest");
