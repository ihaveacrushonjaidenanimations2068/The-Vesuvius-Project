...
import com.varahunter.awholenewperspective.particle.ForwardPortalParticle;
import com.varahunter.awholenewperspective.item.WastelandItem;
...
public class WastelandDimension extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:wasteland")
	public static final ModDimension dimension = null;
	@ObjectHolder("a_whole_new_perspective:wasteland_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public WastelandDimension(AWholeNewPerspectiveModElements instance) {
		super(instance, 49);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("wasteland"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("a_whole_new_perspective:wasteland")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("a_whole_new_perspective:wasteland"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("a_whole_new_perspective:wasteland"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("a_whole_new_perspective:dead_forest")),
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.addParticle(ForwardPortalParticle.particle, px, py, pz, vx, vy, vz);
			}
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = WastelandDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "wasteland_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = WastelandDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
