...
public class VividoniaDimension extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:vividonia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public VividoniaDimension(AWholeNewPerspectiveModElements instance) {
		super(instance, 9);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("vividonia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("a_whole_new_perspective:vividonia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("a_whole_new_perspective:vividonia"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("a_whole_new_perspective:vividonia"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("a_whole_new_perspective:petrified_grove")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("a_whole_new_perspective:erratic_petrified_field")),};
	}
