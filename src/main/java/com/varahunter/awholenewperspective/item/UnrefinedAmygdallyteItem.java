...
public class UnrefinedAmygdallyteItem extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:unrefined_amygdallyte")
	public static final Item block = null;
	public UnrefinedAmygdallyteItem(AWholeNewPerspectiveModElements instance) {
		super(instance, 105);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unrefined_amygdallyte");
		}
