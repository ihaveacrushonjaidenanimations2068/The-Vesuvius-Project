...
public class PlasmaPistolItem extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:plasma_pistol")
	public static final Item block = null;
	@ObjectHolder("a_whole_new_perspective:entitybulletplasma_pistol")
	public static final EntityType arrow = null;
	public PlasmaPistolItem(AWholeNewPerspectiveModElements instance) {
		super(instance, 96);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletplasma_pistol").setRegistryName("entitybulletplasma_pistol"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 20, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(TripmineItemItem.block, (int) (1));
		}
