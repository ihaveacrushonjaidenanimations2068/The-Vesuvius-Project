...
import com.varahunter.awholenewperspective.procedures.TripmineItemBulletHitsBlockProcedure;
...
public class TripmineItemItem extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:tripmine_item")
	public static final Item block = null;
	@ObjectHolder("a_whole_new_perspective:entitybullettripmine_item")
	public static final EntityType arrow = null;
	public TripmineItemItem(AWholeNewPerspectiveModElements instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettripmine_item").setRegistryName("entitybullettripmine_item"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AWNPItemsItemGroup.tab).maxDamage(100));
			setRegistryName("tripmine_item");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Audiotape01Item.block, (int) (1));
		}
			...
			if (this.inGround) {
				{
					...
					TripmineItemBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("a_whole_new_perspective:textures/enforcer_tripmine.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelEnforcerTeripmine();
