...
public class PulseTurretProjectileItem extends AWholeNewPerspectiveModElements.ModElement {
	@ObjectHolder("a_whole_new_perspective:pulse_turret_projectile")
	public static final Item block = null;
	@ObjectHolder("a_whole_new_perspective:entitybulletpulse_turret_projectile")
	public static final EntityType arrow = null;
	public PulseTurretProjectileItem(AWholeNewPerspectiveModElements instance) {
		super(instance, 44);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpulse_turret_projectile").setRegistryName("entitybulletpulse_turret_projectile"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("pulse_turret_projectile");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(PulseTurretProjectileItem.block, (int) (1));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("a_whole_new_perspective:textures/energy_beam_purple.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelEnergyBeamFixed();
